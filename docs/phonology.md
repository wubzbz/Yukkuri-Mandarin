...
油库里（ゆっくり）是一个日语副词或形容词，意思是“慢慢地”、“不慌不忙地”、“悠闲地”。起初，在某论坛上经常有人发东方Project的主角博丽灵梦和雾雨魔理沙的Ascii头像，配以文字“ゆっくりしていってね！！！”（慢慢来！！！）。久而久之，人们便以“ゆっくり”（油库里）指代这种角色头像。

当时，在Niconico动画上，很多有关油库里形象的视频都使用了语音合成软件（如SofTalk、AquesTalk等）生成的，特征为语速缓慢、音调平稳的电子声音作为配音，以至于这种合成的声音本身也被大家当做油库里形象的声音，成为了”油库里文化“的一部分，即“油库里语音”。

这种合成声音听起来很悠闲、呆萌，几乎没有语调的起伏，有种奇特的幽默感。使用场景有：
...
- [ZUNさん退職！ ニコニコでのブーム、「ゆっくり」ってなんなの？ そして「東方警察」について](https://touhougarakuta.com/article/specialtaidan_zun_hiroyuki_8/)
...
> [!TIP]
> 一个音节一般至少有两拍，在正常的日语语速下念出来会显得很慢。所以生成语音时可以把语速调高一些。
